...
imuNode::imuNode() : nh_priv_("~") {
	...
	param::param<bool>("~publish_gps",publish_gps_,false);
	param::param<bool>("~publish_gps_as_odom",publish_gps_as_odom_,false);
	param::param<bool>("~publish_nav_odom",publish_nav_odom_,false);
	//param::param<bool>("~nav_odom_rel",nav_odom_rel_,true);
	param::param<bool>("~publish_nav_pose",publish_nav_pose_,false);
	param::param<bool>("~publish_nav_fix",publish_nav_fix_,false);
